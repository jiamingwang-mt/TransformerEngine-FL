...
def _torch_dtype_to_te_dtype(torch_dtype, tex_module):
    ...
    if type(torch_dtype).__name__ == 'DType' and type(torch_dtype).__module__ == 'transformer_engine_musa_torch':
        return torch_dtype
...
class MUSABackend(TEFLBackendBase):
    ...
    def get_attention_backend(self, attention_params=None):
        ...
        from transformer_engine_musa.pytorch.attention import get_attention_backend as _original_get_attention_backend
    ...
    def get_fused_attn_backend(self, *args, **kwargs) -> int:
        ...
        def convert_enum(py_enum, native_enum_class):
            ...
            if type(py_enum).__module__ == 'transformer_engine_musa_torch':
                return py_enum
